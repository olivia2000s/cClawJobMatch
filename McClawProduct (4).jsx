...
const HERO_LORE = [
  ...
  // bottom band — the open strip beneath the content
  { t: "spare time → $MCLAW", x: 28, y: 78 },
  { t: "proof, not promises", x: 14, y: 84 },
  { t: "every task is escrowed", x: 36, y: 90 },
  { t: "no resume? no problem.", x: 56, y: 85 },
  { t: "reputation compounds", x: 74, y: 91 },
  { t: "the work is real", x: 90, y: 86 },
];
  ...
  return (
    <div className="hero-reveal">
      {HERO_LORE.map((s, i) => {
        ...
        return <span key={i} className="hr-msg" style={{ left: `${s.x}%`, top: `${s.y}%`, opacity: op, filter: `blur(${(1 - op) * 3}px)` }}>// {s.t}</span>;
      })}
...
function ProfilePage({ profile, onSave, onQuiz }) {
...
function quizToProfile(a) {
  ...
  return {
    ...
    locations: [], anyLocation: false, linkedin: false, projects: [], transcriptText: "",
  ...
  return (
    <div className="quiz-wrap">
      ...
      <div className="quiz-top">
        <div className="quiz-logo mono">&gt;_ McClaw</div>
